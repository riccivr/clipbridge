...
static const char *strings_en[STR_COUNT] = {
	...
	[STR_MODE_SLACK]           = "Slack / Discord (mrkdwn)",
	[STR_MODE_JIRA]            = "Jira / Confluence",
	[STR_MODE_TERMINAL]        = "Terminal ANSI",
	[STR_STRIP_TRACKING]       = "Strip URL Tracking Parameters",
...
static const char *strings_es[STR_COUNT] = {
	...
	[STR_MODE_JIRA]            = "Jira / Confluence",
	[STR_MODE_TERMINAL]        = "Terminal ANSI",
	[STR_STRIP_TRACKING]       = "Limpiar rastreo en URLs",
